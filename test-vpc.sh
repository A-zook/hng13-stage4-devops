...
echo "0 Environment Preparation (Critical)"
# Ensure dependencies
sudo apt update -y
...
echo "1. Clean and Detect Correct Internet Interface"
...
echo "2. Kernel & Bridge Configuration (Prevent Forwarding Issues)"
...
echo "4. Add Public & Private Subnets"
...
echo "5. Verify and Enable Bridge Forwarding (Before Pings)"
...
echo "6. Verify Internal Networking"
...
echo "7. Test Intra-VPC Connectivity"
...
echo "8. Test Internet Access (NAT)"
...
echo "9. Deploy and Test Applications"
...
echo "10. Firewall Policy Setup (Pre-Verified CIDR)"
mkdir -p policies
...
echo "11. VPC Peering (Optional Advanced Test)"
# Create 2nd VPC
...
echo "12. State File Verification"
ls -la state/
